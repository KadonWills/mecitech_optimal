...
const HardwarePerformanceCard:FunctionComponent<HardwarePerformanceCardProps> = ({title, icon, attributes}) => {
  return (
    <div className='flex flex-col space-y-4 items-center w-full h-max' >
        ...
        <div className='flex flex-col space-y-3 w-full  items-center'>
            {
                attributes.map((attr) => (
                    <div className='flex flex-row flex-1 space-x-1 w-full text-xs font-medium font-mono  mx-auto'> 
