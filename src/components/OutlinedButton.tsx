...
const  Button:FunctionComponent<ButtonProps> = ({type, text, icon, styleClass, handleOnClick, leadingIcon=true, disabled=false}) => {
  return (
    ...
    className={`max-w-max py-1 px-3 border border-primary dark:border-secondary hover:bg-primary dark:hover:bg-secondary ${ !disabled && ' bg-opacity-50'} disabled:opacity-30
