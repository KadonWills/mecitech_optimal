...
const Splash = () => (
    <div className='z-[100]  m-0 p-0 fixed top-0 left-0 w-[100vw] h-full bg-light bg-opacity-90'>
        ...
        <div className=" mx-auto md:w-full h-[100vh] relative grid place-content-center justify-center text-center m-0 bg-opacity-70  bg-light dark:bg-dark text-primary dark:text-light ">
            <div className='scale-110 w-[90vw]'>
                <h1 className="text-4xl md:text-[60px] md:tracking-[0.245em] leading-[1.8em] font-black">OPTIMAL</h1>
